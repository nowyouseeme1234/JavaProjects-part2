    ...
    public void handle(ActionEvent actionEvent) {
        if (actionEvent.getSource().equals(createBtn)){
            ...
            try {
                ...
                String sql3 ="Insert into `employee_info` (`Age`, `Review`, `Attendance`, `Shift`, `Department`, `Salary`, `Username`) Values(?,?,?,?,?,?,?)";
                ...
                pstmt2.setInt(3, FI);
                pstmt2.setString(4, "e");
                pstmt2.executeUpdate();


                PreparedStatement pstmt3 = con.prepareStatement(sql3);
                pstmt3.setInt(1, Integer.parseInt(empAge));
                pstmt3.setInt(2, 9);
                pstmt3.setInt(3,7);
                pstmt3.setString(4, empShift);
                pstmt3.setString(5, empDept);
                pstmt3.setInt(6, Integer.parseInt(empSalary));
                pstmt3.setString(7,empUsername);
